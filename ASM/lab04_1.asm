...
MAIN PROC
    ...
    ;copia o valor 50, que é o numero de vezes que o loop sera realizado, a BL
    MOV BL,50
    ...
    VOLTA:
        ...
        ;diminui em 1 o valor de BL
        DEC BL

        ;pula de volta para o começo do rotulo caso BL nao for 0
        JNZ VOLTA
